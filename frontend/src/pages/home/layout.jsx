...
import StoreOwnerProductImages from "../../components/store_owner/store_owner_product_images";
...
function LayoutInner() {
  ...
  const renderPage = () => {
    ...
    switch (activePage) {
      ...
      case "StoreOwner:Quản lý hình ảnh sản phẩm":
        return <StoreOwnerProductImages {...commonProps} />;
